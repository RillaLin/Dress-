<?php
  ...
  $sql2="SELECT * FROM product WHERE psprice > poprice ORDER BY poprice LIMIT {$_SESSION['start']},6;";   //照銷售數量高到低排
...
<body>
  ...
  <div class="sa">
    ...
    <table>
      ...
      <tr>
        <?php
          ...
          while($row2 = mysqli_fetch_array($result2)){
              ...
              $_SESSION["img_id"]='home3';
              echo  "<td><a href='batvest.php?pr={$row2['pid']}&st={$row2['sid']}'><img src='http://localhost/dress/test3.php?limit2={$_SESSION["cnt"]},1' width='150' height='180'></a></td>";   //典籍圖片需跳至自己的商品頁
              $_SESSION["cnt"]++;
          }
      ...
      <tr>
        <?php
          $sql3="SELECT * FROM product WHERE psprice > poprice ORDER BY poprice LIMIT {$_SESSION['start']},6;";   //照銷售數量高到低排
          $result3=mysqli_query($conn,$sql3);
          while($row3 = mysqli_fetch_array($result3)){
              $_SESSION["tablename"]='product';
              $_SESSION["img_id"]='home3';
              echo  "<td><a href='batvest.php?pr={$row3['pid']}&st={$row3['sid']}'><img src='http://localhost/dress/test3.php?limit2={$_SESSION["cnt"]},1' width='150' height='180'></a></td>";        //典籍圖片需跳至自己的商品頁
              $_SESSION["cnt"]++;
          }
