...
<body>
	...
	<div id="title2">
		<form name="editpsd" method="post" action="edit_psd.php">
		請輸入舊密碼:<input type="password" name="opsd"> <br/><br/>	
		新密碼:<input type="password" name="psd"> <br/><br/>
		再次輸入密碼:<input type="password" name="againpsd"> <br/><br/>
